...
function Update () 
{
	...
	if(talkMode)
	{
		...
		{
            if (i == 0) text = "收到了方块酱的求救信息";
		    if (i == 1) text = "所以这种时候肯定又要靠我了吧";
            if (i == 2) text = "不过它在城堡顶端呢";
            if (i == 3) text = "我这样要怎么帮助他呢";
            if (i == 4) text = "哦对了！";
            if (i >= 5) { text = "看我飞上去";obj.transform.position = Vector3.Lerp (obj.transform.position, target.position,Time.deltaTime * 5);}
		}
