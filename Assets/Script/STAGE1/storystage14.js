...
function Update () 
{
	...
	if(talkMode)
	{
	    ...
	    /**说话内容合集*/
		    if (i == 0) text = "xe hre heywhs?";
		    if (i == 1) text = "aaaa???yd fhenda???";
		    if (i == 2) text = "orz!otl!ost!omg!u konw english?";
		    if (i == 3) text = "i can't find her";
		    if (i == 4) text = "her name is elfy";
		    if (i == 5) text = "she is an elf!";
		    if (i == 6) text = "you can help me?";
		    if (i >=7) {text = "waaaaaa";obj.transform.position = Vector3.Lerp (obj.transform.position, target.position,Time.deltaTime * 5);}
