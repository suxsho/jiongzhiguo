...
function Update () 
{
	...
	if(talkMode)
	{
        ...
        {
            if (i == 0) text = "wuhuhuhu,you can't move";
            if (i == 1) text = "I said that you can't beat me.";
            if (i == 2) text = "Now you and the sunglasses are defeated by me";
            if (i == 3) text = "Nobody can stop me!";
            if (i >= 4) { text = "wuhuhuhuhu"; obj.transform.position = Vector3.Lerp(obj.transform.position, target.position, Time.deltaTime * 5); }
        }
		else
		{
            if (i == 0) text = "呜呼呼呼呼呼，动不了了吧";
		    if (i == 1) text = "我可说过你是不可能战胜我的呜";
            if (i == 2) text = "现在你和墨镜都被我战胜了呜";
            if (i == 3) text = "已经没有人可以阻止我了呜！";
            if (i >= 4) { text = "呜呼呼呼呼！";obj.transform.position = Vector3.Lerp (obj.transform.position, target.position,Time.deltaTime * 5);}
		}
...
function gameStart()
{
	...
	talkMode= false;
	Application.LoadLevel ("story4-5-2");	
}
